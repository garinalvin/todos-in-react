...
## DESCRIPTION:
* This is a utility website where you can *manage your tasks*.
* It lets you input your to tasks, deletes or mark them as done.
...
## USAGE:
To run this project locally, follow below instructions.
